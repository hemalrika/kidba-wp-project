...
$tp_blog_layout = get_theme_mod( 'tp_blog_layout', __('right-sidebar', 'kidba') );
if(isset($_GET['s'])) {
	$search = $_GET['s'];
}
?>
	...
	<main id="primary" class="blog-area pt-125 pb-30">
		<div class="container">
			<div class="row justify-content-center">
				<?php if ( is_active_sidebar( 'blog-sidebar' ) && $tp_blog_layout == 'left-sidebar'): ?>
					<div class="col-lg-4">
				...
				<?php if ( is_active_sidebar( 'blog-sidebar' ) && $tp_blog_layout == 'right-sidebar'): ?>
					<div class="col-lg-4">
						<div class="blog__sidebar pl-30">
							<?php dynamic_sidebar('blog-sidebar');?>
						</div>
