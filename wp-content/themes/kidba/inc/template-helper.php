...
function kidba_breadcrumb_func() {
    ...
    ?>
    <div class="banner breadcrumb-banner pt-190 pb-200 <?php print esc_attr( $breadcrumb_overlay_class );?>"  data-bg-color="<?php print esc_attr($breadcrumb_bg_color); ?>" data-background="<?php print esc_attr($breadcrumb_bg_img);?>" data-topspace="<?php print esc_attr($breadcrumb_padding_top); ?>px" data-bottomspace="<?php print esc_attr($breadcrumb_padding_bottom); ?>px">
            <div class="container">
                <div class="row">
                    <div class="col-12">
