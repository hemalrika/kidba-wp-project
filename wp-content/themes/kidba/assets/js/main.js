...
$(document).ready(function(){
    ...
    $("[data-bottomspace]").each(function () {
        $(this).css("padding-bottom", $(this).attr("data-bottomspace"))
    })
    $("[data-topspace]").each(function () {
        $(this).css("padding-top", $(this).attr("data-topspace"))
    })
