...
function _header_side_fields( $fields ) {
    ...
    $fields[] = [
        'type'     => 'textarea',
        'settings' => 'kidba_side_contact_info',
        'label'    => esc_html__( 'Contact Information', 'tp-toolkit' ),
        'section'  => 'header_side_setting',
        'default'  => esc_html__( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Expedita dolorem magni deserunt quod obcaecati alias nostrum sapiente veritatis. Ad, fugiat.', 'tp-toolkit' ),
        'priority' => 10,
        'active_callback' => [
            [
    ...
    $fields[] = [
        'type'     => 'URL',
        'settings' => 'kidba_side_social_insta_link',
        'label'    => esc_html__( 'Instagram Link', 'tp-toolkit' ),
        'section'  => 'header_side_setting',
        'default'  => esc_url( '#'),
        'priority' => 10,
        'active_callback' => [
...
// Blog Setting
    ...
    $fields[] = [
        ...
        'section'  => 'blog_setting',
        'default'  => esc_html__( 'READ MORE', 'tp-toolkit' ),
        'priority' => 10,
    ];
    return $fields;
}
